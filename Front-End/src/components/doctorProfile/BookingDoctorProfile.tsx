...
const BookingDoctorProfile:FC<IProps>= () => {
  return (
    <div className="bg-white  flex flex-col rounded-lg  mb-4 ">
            ...
            <div className="text-sm bg-white p-2 text-gray-500 border-b-2">
            <p className="pb-1 pt-1">Book</p>
            <p>Examination</p>
            </div>

            <div className="flex justify-center items-center  border-b-2  p-3 gap-5">
                <div className="mx-2 flex gap-5 flex-col items-center">
                    <PiMoneyWavy color="blue" size={30} />
                    <p className="text-xs text-start text-gray-400">Fees <span className="text-gray-500 font-bold px-1">350 EGP</span></p>
                </div>
                ...
                <PiCircleHalfFill color="blue" size={30} />
                    <p className="text-xs text-start text-blue-600 ">Waiting Time : 48 Minutes</p>
                </div>
            </div>
            ...
            <div className="flex   border-b-2 p-4">
                ...
                <div className="flex flex-col text-start px-1">
                    ...
                    El-Mohandessin : shehab street . borg alzahraa</p>
            ...
            <div className="flex items-center justify-center font-semibold text-lg text-gray-800 p-3">
